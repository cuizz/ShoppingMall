...
import com.example.lunbo.AbAppData;
import com.example.lunbo.AbInnerViewPager;
import com.example.lunbo.AbOnChangeListener;
import com.example.lunbo.AbOnItemClickListener;
import com.example.lunbo.AbOnScrollListener;
import com.example.lunbo.AbOnTouchListener;
import com.example.lunbo.AbViewPagerAdapter;
...
public class AbSlidingPlayView1 extends LinearLayout {
	 ...
	 * @param context
	 */
	public AbSlidingPlayView1(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 *            the attrs
	 */
	public AbSlidingPlayView1(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

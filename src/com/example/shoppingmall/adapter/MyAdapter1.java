		...
		if (convertView == null) {
           ...
           case TYPE_0:
        	  /* convertView=inflater.inflate(R.layout.zhuye, parent,false);
        	   ...
        	   holder.viewPager = (AbSlidingPlayView1) convertView.findViewById(R.id.viewPager_menu);
...
//     	   holder.img_header.setBackgroundResource(R.drawable.pic);
	...
	class ViewHolder {
		public com.example.shoppingmall.customview.AbSlidingPlayView1 viewPager;
